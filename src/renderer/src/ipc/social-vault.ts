...
export function createSocialVaultApi(bridge: SocialVaultBridge): SocialVaultApi {
  ...
  return {
    ...
    content: {
      ...
      listFilterViews: () => invoke('content:list-filter-views'),
      saveFilterView: (input) => invoke('content:save-filter-view', input),
      deleteFilterView: (id) => invoke('content:delete-filter-view', id),
