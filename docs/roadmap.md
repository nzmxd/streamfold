...
`0.7.11` 已经建立后续版本所需的主要基础设施；`0.7.10` 到 `0.7.11` 进一步加入部分成功同步状态、覆盖信息和清单驱动的通用后台捕获：

| 能力 | 当前状态 | 后续关注点 |
|---|---|---|
| 账号与 Session | 多平台、多账号、独立 Partition、官方入口登录、账号级任务互斥 | 登录失效长时间运行验收、窗口位置恢复 |
| 平台同步 | 小红书、知乎和 X 本人资料、内容、指标 | 异常场景、更多分页、微博与抖音逐平台验收 |
| 内容与统计 | FTS5 内容中心、收藏/标签、筛选导出、观察历史、可靠指标语义与跨账号分析 | 封面缓存、更多导出格式和真实大库回归 |
